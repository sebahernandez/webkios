...
var StyledRoot = (0, _index.styled)('div', function (_ref) {
  ...
  return _objectSpread(_objectSpread(_objectSpread({}, $divider === _constants.DIVIDER.grid || $divider === _constants.DIVIDER.vertical ? (0, _index.expandBorderStyles)($theme.borders.border300) : {}), $divider === _constants.DIVIDER.horizontal ? {
