...
var useList = function (initialList) {
    ...
    return [
        list,
        {
            ...
            updateAt: function (index, entry) { return set(function (currentList) { return currentList.slice(0, index).concat([entry], list.slice(index + 1)); }); },
            remove: function (index) { return set(function (currentList) { return currentList.slice(0, index).concat(list.slice(index + 1)); }); },
